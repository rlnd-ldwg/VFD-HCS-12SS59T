...
const int Pin_VFD_RESET		=	9;			// VFD _RESET
const int Pin_VFD_VDON		=	8;			//     _VDON Vdisp 0=ON 1=OFF
const int Pin_VFD_CS		=	10;			//     _CS   chip select, SPI SS

const int Pin_VFD_SUCLK_A	=	10;			//     SUCLK A, OC2A
const int Pin_VFD_SUCLK_B	=	9; 			//           B,    B, inverted

const int Pin_RED_LED13		=   2;			// LED standard
